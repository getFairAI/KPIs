  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const kpiNewUsersPerWeek = generateChartInfo(labelTime, 'New users', `New users per ${labelTime}`, `Users in ${labelTime}`, mondays, uniqueOwnersScriptPayment, viewOption);
